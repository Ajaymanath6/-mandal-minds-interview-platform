  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div
          className={`${
            firstSidebarOpen ? "w-64" : "w-16"
          } bg-white rounded-lg shadow-sm border border-gray-200 transition-all duration-300 flex-shrink-0 mb-8`}
        >
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 p-2 space-y-2">
              ...
              >
                ...
                {firstSidebarOpen && (
                  <span className="text-sm">Back to Manage Resume</span>
                )}
              </button>
            </nav>
          </div>
        ...
        <div className="flex-1 bg-gray-50 px-6 pb-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Enhance your resume based on job requirements
            </p>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-600">
                  Copy and paste the job description to analyze skill gaps
                </p>
              </div>

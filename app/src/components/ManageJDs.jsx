          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="flex-1 p-2 space-y-2">
              ...
              >
                ...
                {firstSidebarOpen && <span className="font-medium">Back to AI Chat</span>}
              </button>
                      ...
                      {!isCompareMode && (
                        <div className="flex items-center space-x-2" onClick={(e) => e.stopPropagation()}>
                          <button
                            ...
                            className="flex items-center space-x-2 px-4 py-2 border border-purple-600 text-purple-600 hover:bg-purple-50 rounded-lg transition-colors"
                          >
